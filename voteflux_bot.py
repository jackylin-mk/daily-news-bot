...
5. **各市場熱門題目**：印度、孟加拉、越南、馬來西亞、菲律賓、泰國，各 2 題。
   ...
   - 「越南生產的 TXT 超級電池是否會在 2026 年量產？」→「量產」定義模糊，應改為「越南 VinES 電池工廠 2026 年 Q3 前月產能是否會超過 10 萬顆？」
   - 「馬來西亞國家足球隊會在 2026 年東南亞運動會中奪冠嗎？」→ 2026 年沒有東南亞運動會，絕對不可捏造不存在的賽事
   - 「菲律賓 2026 年的海嘯預警系統是否會全面啟用？」→「全面啟用」定義模糊，應改為「菲律賓 PHIVOLCS 海嘯預警系統是否會在 2026 年底前完成全國 50 個沿海站點部署？」
